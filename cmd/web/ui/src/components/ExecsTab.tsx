    ...
    <div className="space-y-4">
      ...
      {execs.length === 0 ? (
        ...
        <table className="w-full text-xs border-collapse">
          ...
          <tbody>
            {execs.map((e) => (
              <tr key={e.id} className="border-b border-zinc-800/50 hover:bg-zinc-900">
                <Td><code className="text-yellow-400">{e.id.slice(0, 16)}</code></Td>
                <Td className="text-cyan-400">{e.container}</Td>
                <Td className="text-zinc-300">{e.cmd}</Td>
